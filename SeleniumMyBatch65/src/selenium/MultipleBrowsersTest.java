...
public class MultipleBrowsersTest {
	...
	public static void main(String[] args) throws IOException {
		...
		FileInputStream f =new FileInputStream("C:\\Selenium_WorkSpace\\SeleniumMyBatch65\\src\\prop.properties");
		Properties prop = new Properties();
		prop.load(f);
		
		String browser = prop.getProperty("browser"); // Firefox, Chrome, Safari //read data from excel
